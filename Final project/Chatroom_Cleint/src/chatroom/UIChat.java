...
public class UIChat extends javax.swing.JFrame {
    ...
    public void Setup(ChtrmCli tclient, String tusername){
        client= tclient;
        username = tusername;
        jLabel3.setText(chatWindowName);
        jLabel5.setText(tusername);
    }
    public void addmessage(String msg){
        jTextArea1.append(msg+"\n");
    }
    public void updateListAddUser(String user){
    ...
    public void updateListRemoveUserOn(String user){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!textTobeSent.isEmpty()){
            try {
                ...
                client.sendToServer(textTobeSent,chatWindowName);
...
//        client.send(new Message("leave", uname, chat_window_name, "server"));
        client.exitGroup(chatWindowName);
